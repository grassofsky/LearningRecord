...
int main()
{
    ...
    compass->setPlate(createCompassPart(cookdatapath + "compass_plate.png", 1.5f, -1.0f));
    compass->setNeedle(createCompassPart(cookdatapath + "compass_needle.png", 1.5f, 0.0f));
    ...
    compass->getOrCreateStateSet()->setMode(GL_BLEND, osg::StateAttribute::OFF);

    osg::ref_ptr<osg::Group> root = new osg::Group;
    root->addChild( createEarth(datapath+"Images/land_shallow_topo_2048.png") );
