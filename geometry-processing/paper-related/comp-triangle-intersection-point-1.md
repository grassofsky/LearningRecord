...
关于该论文的介绍参见：[PaperRead - A fast triangle-triangle intersection test](https://www.cnblogs.com/grass-and-moon/p/13297665.html)

基于该论文的相交测试实现，参见：[PaperImpl - A fast triangle-triangle intersection test](https://www.cnblogs.com/grass-and-moon/p/13300247.html)
...
具体实现在之前[相交测试代码](https://www.cnblogs.com/grass-and-moon/p/13300247.html)的基础上，增加了两个平面相交求解的过程。完整代码如下：
...
![](./image/diagram_triangle_interp1.png)